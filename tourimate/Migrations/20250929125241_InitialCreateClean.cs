        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    AcceptEmailMarketing = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TourGuideApplications_Users_ReviewedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tours_Users_TourGuideId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeSlot = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    Participants = table.Column<int>(type: "int", nullable: false),
                    ParticipantDetails = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TotalAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Currency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PaymentStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Promotions_Users_RequestedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxParticipants = table.Column<int>(type: "int", nullable: false),
                    BookedParticipants = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Currency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
                    PayoutStatus = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "CreatedAt", "DeletedAt", "Description", "Icon", "IsActive", "IsDeleted", "Name", "ParentId", "SortOrder", "UpdatedAt" },
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), new DateTime(2025, 9, 29, 12, 52, 41, 455, DateTimeKind.Utc).AddTicks(3888), null, "Traditional Vietnamese food and drinks", null, true, false, "Food & Beverages", null, 1, new DateTime(2025, 9, 29, 12, 52, 41, 455, DateTimeKind.Utc).AddTicks(3889) },
                    { new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2025, 9, 29, 12, 52, 41, 455, DateTimeKind.Utc).AddTicks(3894), null, "Handmade crafts and artisan products", null, true, false, "Handicrafts", null, 2, new DateTime(2025, 9, 29, 12, 52, 41, 455, DateTimeKind.Utc).AddTicks(3894) },
                    { new Guid("33333333-3333-3333-3333-333333333333"), new DateTime(2025, 9, 29, 12, 52, 41, 455, DateTimeKind.Utc).AddTicks(3898), null, "Traditional clothing and fabrics", null, true, false, "Textiles", null, 3, new DateTime(2025, 9, 29, 12, 52, 41, 455, DateTimeKind.Utc).AddTicks(3899) }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_TourDate_Status",
                table: "Bookings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Promotions_RequestedBy",
                table: "Promotions",
                column: "RequestedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_EntityId_EntityType_Status",
                table: "Reviews",
                columns: new[] { "EntityId", "EntityType", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TourGuideApplications_ReviewedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tours_Location_IsActive",
                table: "Tours",
