...
namespace tourimate.Migrations
{
    ...
    [Migration("20251028054101_AddTransactionDirectionToTransaction")]
    partial class AddTransactionDirectionToTransaction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Models.ProductCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 28, 5, 41, 0, 685, DateTimeKind.Utc).AddTicks(2207),
                            Description = "Traditional Vietnamese food and drinks",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Food & Beverages",
                            SortOrder = 1,
                            UpdatedAt = new DateTime(2025, 10, 28, 5, 41, 0, 685, DateTimeKind.Utc).AddTicks(2208)
                        },
                        new
                        {
                            Id = new Guid("22222222-2222-2222-2222-222222222222"),
                            CreatedAt = new DateTime(2025, 10, 28, 5, 41, 0, 685, DateTimeKind.Utc).AddTicks(2213),
                            Description = "Handmade crafts and artisan products",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Handicrafts",
                            SortOrder = 2,
                            UpdatedAt = new DateTime(2025, 10, 28, 5, 41, 0, 685, DateTimeKind.Utc).AddTicks(2214)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2025, 10, 28, 5, 41, 0, 685, DateTimeKind.Utc).AddTicks(2217),
                            Description = "Traditional clothing and fabrics",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Textiles",
                            SortOrder = 3,
                            UpdatedAt = new DateTime(2025, 10, 28, 5, 41, 0, 685, DateTimeKind.Utc).AddTicks(2217)
                        });
                });
            ...
            modelBuilder.Entity("Entities.Models.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("74e8a44b-d841-4b46-9c45-ab241acd08a5"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 10, 28, 5, 41, 0, 685, DateTimeKind.Utc).AddTicks(2439),
                            Description = "Commission rate for tour bookings",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Tours",
                            UpdatedAt = new DateTime(2025, 10, 28, 5, 41, 0, 685, DateTimeKind.Utc).AddTicks(2439),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("e9b63921-b5c3-4ddb-a64a-12c79811adec"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 10, 28, 5, 41, 0, 685, DateTimeKind.Utc).AddTicks(2453),
                            Description = "Commission rate for product sales",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Products",
                            UpdatedAt = new DateTime(2025, 10, 28, 5, 41, 0, 685, DateTimeKind.Utc).AddTicks(2453),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("37b365ce-3b32-4b19-9144-31ab46f8d893"),
                            Category = "Security",
                            CreatedAt = new DateTime(2025, 10, 28, 5, 41, 0, 685, DateTimeKind.Utc).AddTicks(2456),
                            Description = "OTP expiry time in minutes",
                            IsDeleted = false,
                            IsPublic = false,
                            Key = "OTP_ExpiryMinutes",
                            UpdatedAt = new DateTime(2025, 10, 28, 5, 41, 0, 685, DateTimeKind.Utc).AddTicks(2457),
                            Value = "5"
                        });
                });
