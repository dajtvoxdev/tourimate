...
namespace tourimate.Migrations
{
    ...
    [Migration("20251103181842_AddProductsUserIdPlaceholder")]
    partial class AddProductsUserIdPlaceholder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Models.ProductCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 3, 18, 18, 41, 613, DateTimeKind.Utc).AddTicks(3980),
                            Description = "Traditional Vietnamese food and drinks",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Food & Beverages",
                            SortOrder = 1,
                            UpdatedAt = new DateTime(2025, 11, 3, 18, 18, 41, 613, DateTimeKind.Utc).AddTicks(3982)
                        },
                        new
                        {
                            Id = new Guid("22222222-2222-2222-2222-222222222222"),
                            CreatedAt = new DateTime(2025, 11, 3, 18, 18, 41, 613, DateTimeKind.Utc).AddTicks(4021),
                            Description = "Handmade crafts and artisan products",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Handicrafts",
                            SortOrder = 2,
                            UpdatedAt = new DateTime(2025, 11, 3, 18, 18, 41, 613, DateTimeKind.Utc).AddTicks(4022)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2025, 11, 3, 18, 18, 41, 613, DateTimeKind.Utc).AddTicks(4025),
                            Description = "Traditional clothing and fabrics",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Textiles",
                            SortOrder = 3,
                            UpdatedAt = new DateTime(2025, 11, 3, 18, 18, 41, 613, DateTimeKind.Utc).AddTicks(4025)
                        });
                });
            ...
            modelBuilder.Entity("Entities.Models.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b51d4859-fafc-4f33-a7d9-b755c41edbae"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 11, 3, 18, 18, 41, 613, DateTimeKind.Utc).AddTicks(4344),
                            Description = "Commission rate for tour bookings",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Tours",
                            UpdatedAt = new DateTime(2025, 11, 3, 18, 18, 41, 613, DateTimeKind.Utc).AddTicks(4344),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("af4e0b5c-e302-49df-8a65-c5e227412784"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 11, 3, 18, 18, 41, 613, DateTimeKind.Utc).AddTicks(4369),
                            Description = "Commission rate for product sales",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Products",
                            UpdatedAt = new DateTime(2025, 11, 3, 18, 18, 41, 613, DateTimeKind.Utc).AddTicks(4370),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("abc291dc-e966-41d1-84d6-667803af34bb"),
                            Category = "Security",
                            CreatedAt = new DateTime(2025, 11, 3, 18, 18, 41, 613, DateTimeKind.Utc).AddTicks(4373),
                            Description = "OTP expiry time in minutes",
                            IsDeleted = false,
                            IsPublic = false,
                            Key = "OTP_ExpiryMinutes",
                            UpdatedAt = new DateTime(2025, 11, 3, 18, 18, 41, 613, DateTimeKind.Utc).AddTicks(4373),
                            Value = "5"
                        });
                });
