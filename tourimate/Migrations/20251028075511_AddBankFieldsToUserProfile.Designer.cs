...
namespace tourimate.Migrations
{
    ...
    [Migration("20251028075511_AddBankFieldsToUserProfile")]
    partial class AddBankFieldsToUserProfile
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Models.ProductCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 28, 7, 55, 10, 49, DateTimeKind.Utc).AddTicks(9146),
                            Description = "Traditional Vietnamese food and drinks",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Food & Beverages",
                            SortOrder = 1,
                            UpdatedAt = new DateTime(2025, 10, 28, 7, 55, 10, 49, DateTimeKind.Utc).AddTicks(9149)
                        },
                        new
                        {
                            Id = new Guid("22222222-2222-2222-2222-222222222222"),
                            CreatedAt = new DateTime(2025, 10, 28, 7, 55, 10, 49, DateTimeKind.Utc).AddTicks(9155),
                            Description = "Handmade crafts and artisan products",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Handicrafts",
                            SortOrder = 2,
                            UpdatedAt = new DateTime(2025, 10, 28, 7, 55, 10, 49, DateTimeKind.Utc).AddTicks(9155)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2025, 10, 28, 7, 55, 10, 49, DateTimeKind.Utc).AddTicks(9159),
                            Description = "Traditional clothing and fabrics",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Textiles",
                            SortOrder = 3,
                            UpdatedAt = new DateTime(2025, 10, 28, 7, 55, 10, 49, DateTimeKind.Utc).AddTicks(9159)
                        });
                });
            ...
            modelBuilder.Entity("Entities.Models.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("50d46564-a475-4d2a-8e83-ea0c1f1cf3ec"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 10, 28, 7, 55, 10, 49, DateTimeKind.Utc).AddTicks(9590),
                            Description = "Commission rate for tour bookings",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Tours",
                            UpdatedAt = new DateTime(2025, 10, 28, 7, 55, 10, 49, DateTimeKind.Utc).AddTicks(9591),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("91c3b8b6-db27-4fdb-802e-1187f1393a52"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 10, 28, 7, 55, 10, 49, DateTimeKind.Utc).AddTicks(9594),
                            Description = "Commission rate for product sales",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Products",
                            UpdatedAt = new DateTime(2025, 10, 28, 7, 55, 10, 49, DateTimeKind.Utc).AddTicks(9595),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("98004e01-c59f-4867-b02e-b9aa80cede02"),
                            Category = "Security",
                            CreatedAt = new DateTime(2025, 10, 28, 7, 55, 10, 49, DateTimeKind.Utc).AddTicks(9598),
                            Description = "OTP expiry time in minutes",
                            IsDeleted = false,
                            IsPublic = false,
                            Key = "OTP_ExpiryMinutes",
                            UpdatedAt = new DateTime(2025, 10, 28, 7, 55, 10, 49, DateTimeKind.Utc).AddTicks(9598),
                            Value = "5"
                        });
                });
