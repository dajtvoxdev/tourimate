...
namespace tourimate.Migrations
{
    ...
    [Migration("20251028044648_IncreaseSePayTransactionFieldSizesV2")]
    partial class IncreaseSePayTransactionFieldSizesV2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Models.ProductCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 28, 4, 46, 46, 976, DateTimeKind.Utc).AddTicks(4790),
                            Description = "Traditional Vietnamese food and drinks",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Food & Beverages",
                            SortOrder = 1,
                            UpdatedAt = new DateTime(2025, 10, 28, 4, 46, 46, 976, DateTimeKind.Utc).AddTicks(4791)
                        },
                        new
                        {
                            Id = new Guid("22222222-2222-2222-2222-222222222222"),
                            CreatedAt = new DateTime(2025, 10, 28, 4, 46, 46, 976, DateTimeKind.Utc).AddTicks(4796),
                            Description = "Handmade crafts and artisan products",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Handicrafts",
                            SortOrder = 2,
                            UpdatedAt = new DateTime(2025, 10, 28, 4, 46, 46, 976, DateTimeKind.Utc).AddTicks(4796)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2025, 10, 28, 4, 46, 46, 976, DateTimeKind.Utc).AddTicks(4799),
                            Description = "Traditional clothing and fabrics",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Textiles",
                            SortOrder = 3,
                            UpdatedAt = new DateTime(2025, 10, 28, 4, 46, 46, 976, DateTimeKind.Utc).AddTicks(4800)
                        });
                });
            ...
            modelBuilder.Entity("Entities.Models.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d1036436-4eb6-4e8f-ba15-c9509b90a015"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 10, 28, 4, 46, 46, 976, DateTimeKind.Utc).AddTicks(5066),
                            Description = "Commission rate for tour bookings",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Tours",
                            UpdatedAt = new DateTime(2025, 10, 28, 4, 46, 46, 976, DateTimeKind.Utc).AddTicks(5067),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("ff5bc239-0b6b-4ab2-bead-57e2160c792a"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 10, 28, 4, 46, 46, 976, DateTimeKind.Utc).AddTicks(5070),
                            Description = "Commission rate for product sales",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Products",
                            UpdatedAt = new DateTime(2025, 10, 28, 4, 46, 46, 976, DateTimeKind.Utc).AddTicks(5071),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("253e56c0-6b23-4ca4-be4c-0d6ef31de91f"),
                            Category = "Security",
                            CreatedAt = new DateTime(2025, 10, 28, 4, 46, 46, 976, DateTimeKind.Utc).AddTicks(5074),
                            Description = "OTP expiry time in minutes",
                            IsDeleted = false,
                            IsPublic = false,
                            Key = "OTP_ExpiryMinutes",
                            UpdatedAt = new DateTime(2025, 10, 28, 4, 46, 46, 976, DateTimeKind.Utc).AddTicks(5074),
                            Value = "5"
                        });
                });
