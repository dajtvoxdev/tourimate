...
namespace tourimate.Migrations
{
    ...
    [Migration("20251103183530_RemoveUserProductsNavigation")]
    partial class RemoveUserProductsNavigation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Models.ProductCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 3, 18, 35, 29, 624, DateTimeKind.Utc).AddTicks(3570),
                            Description = "Traditional Vietnamese food and drinks",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Food & Beverages",
                            SortOrder = 1,
                            UpdatedAt = new DateTime(2025, 11, 3, 18, 35, 29, 624, DateTimeKind.Utc).AddTicks(3572)
                        },
                        new
                        {
                            Id = new Guid("22222222-2222-2222-2222-222222222222"),
                            CreatedAt = new DateTime(2025, 11, 3, 18, 35, 29, 624, DateTimeKind.Utc).AddTicks(3581),
                            Description = "Handmade crafts and artisan products",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Handicrafts",
                            SortOrder = 2,
                            UpdatedAt = new DateTime(2025, 11, 3, 18, 35, 29, 624, DateTimeKind.Utc).AddTicks(3581)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2025, 11, 3, 18, 35, 29, 624, DateTimeKind.Utc).AddTicks(3585),
                            Description = "Traditional clothing and fabrics",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Textiles",
                            SortOrder = 3,
                            UpdatedAt = new DateTime(2025, 11, 3, 18, 35, 29, 624, DateTimeKind.Utc).AddTicks(3586)
                        });
                });
            ...
            modelBuilder.Entity("Entities.Models.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("103d0d7d-cc1d-4fd1-a23d-5828d39015ab"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 11, 3, 18, 35, 29, 624, DateTimeKind.Utc).AddTicks(3914),
                            Description = "Commission rate for tour bookings",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Tours",
                            UpdatedAt = new DateTime(2025, 11, 3, 18, 35, 29, 624, DateTimeKind.Utc).AddTicks(3915),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("9816eb35-c10e-4ea5-9143-a8e2aa618242"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 11, 3, 18, 35, 29, 624, DateTimeKind.Utc).AddTicks(3919),
                            Description = "Commission rate for product sales",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Products",
                            UpdatedAt = new DateTime(2025, 11, 3, 18, 35, 29, 624, DateTimeKind.Utc).AddTicks(3919),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("44b65c34-7aaa-4b68-b4eb-934922a25e08"),
                            Category = "Security",
                            CreatedAt = new DateTime(2025, 11, 3, 18, 35, 29, 624, DateTimeKind.Utc).AddTicks(3928),
                            Description = "OTP expiry time in minutes",
                            IsDeleted = false,
                            IsPublic = false,
                            Key = "OTP_ExpiryMinutes",
                            UpdatedAt = new DateTime(2025, 11, 3, 18, 35, 29, 624, DateTimeKind.Utc).AddTicks(3929),
                            Value = "5"
                        });
                });
