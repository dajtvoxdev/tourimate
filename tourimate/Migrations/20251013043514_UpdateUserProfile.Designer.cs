...
namespace tourimate.Migrations
{
    ...
    [Migration("20251013043514_UpdateUserProfile")]
            ...
            modelBuilder.Entity("Entities.Models.ProductCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 13, 4, 35, 12, 686, DateTimeKind.Utc).AddTicks(5336),
                            Description = "Traditional Vietnamese food and drinks",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Food & Beverages",
                            SortOrder = 1,
                            UpdatedAt = new DateTime(2025, 10, 13, 4, 35, 12, 686, DateTimeKind.Utc).AddTicks(5336)
                        },
                        new
                        {
                            Id = new Guid("22222222-2222-2222-2222-222222222222"),
                            CreatedAt = new DateTime(2025, 10, 13, 4, 35, 12, 686, DateTimeKind.Utc).AddTicks(5341),
                            Description = "Handmade crafts and artisan products",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Handicrafts",
                            SortOrder = 2,
                            UpdatedAt = new DateTime(2025, 10, 13, 4, 35, 12, 686, DateTimeKind.Utc).AddTicks(5341)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2025, 10, 13, 4, 35, 12, 686, DateTimeKind.Utc).AddTicks(5344),
                            Description = "Traditional clothing and fabrics",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Textiles",
                            SortOrder = 3,
                            UpdatedAt = new DateTime(2025, 10, 13, 4, 35, 12, 686, DateTimeKind.Utc).AddTicks(5345)
                        });
                });
            ...
            modelBuilder.Entity("Entities.Models.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a010ccd4-fc2b-41bd-b664-ca4d89f65179"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 10, 13, 4, 35, 12, 686, DateTimeKind.Utc).AddTicks(5519),
                            Description = "Commission rate for tour bookings",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Tours",
                            UpdatedAt = new DateTime(2025, 10, 13, 4, 35, 12, 686, DateTimeKind.Utc).AddTicks(5520),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("fa167024-0044-45d2-9100-da9e0f509ac3"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 10, 13, 4, 35, 12, 686, DateTimeKind.Utc).AddTicks(5538),
                            Description = "Commission rate for product sales",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Products",
                            UpdatedAt = new DateTime(2025, 10, 13, 4, 35, 12, 686, DateTimeKind.Utc).AddTicks(5538),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("d845e6b1-0e92-4fbc-abed-efdfdf5c7185"),
                            Category = "Security",
                            CreatedAt = new DateTime(2025, 10, 13, 4, 35, 12, 686, DateTimeKind.Utc).AddTicks(5542),
                            Description = "OTP expiry time in minutes",
                            IsDeleted = false,
                            IsPublic = false,
                            Key = "OTP_ExpiryMinutes",
                            UpdatedAt = new DateTime(2025, 10, 13, 4, 35, 12, 686, DateTimeKind.Utc).AddTicks(5542),
                            Value = "5"
                        });
                });
