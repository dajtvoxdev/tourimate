...
namespace tourimate.Migrations
{
    ...
    [Migration("20251103171025_MakeProductDescriptionUnlimited")]
    partial class MakeProductDescriptionUnlimited
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Models.ProductCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 3, 17, 10, 24, 604, DateTimeKind.Utc).AddTicks(4029),
                            Description = "Traditional Vietnamese food and drinks",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Food & Beverages",
                            SortOrder = 1,
                            UpdatedAt = new DateTime(2025, 11, 3, 17, 10, 24, 604, DateTimeKind.Utc).AddTicks(4032)
                        },
                        new
                        {
                            Id = new Guid("22222222-2222-2222-2222-222222222222"),
                            CreatedAt = new DateTime(2025, 11, 3, 17, 10, 24, 604, DateTimeKind.Utc).AddTicks(4038),
                            Description = "Handmade crafts and artisan products",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Handicrafts",
                            SortOrder = 2,
                            UpdatedAt = new DateTime(2025, 11, 3, 17, 10, 24, 604, DateTimeKind.Utc).AddTicks(4039)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2025, 11, 3, 17, 10, 24, 604, DateTimeKind.Utc).AddTicks(4042),
                            Description = "Traditional clothing and fabrics",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Textiles",
                            SortOrder = 3,
                            UpdatedAt = new DateTime(2025, 11, 3, 17, 10, 24, 604, DateTimeKind.Utc).AddTicks(4042)
                        });
                });
            ...
            modelBuilder.Entity("Entities.Models.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("47cc7d92-3069-40b8-a9bb-5e7d04713c7f"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 11, 3, 17, 10, 24, 604, DateTimeKind.Utc).AddTicks(4268),
                            Description = "Commission rate for tour bookings",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Tours",
                            UpdatedAt = new DateTime(2025, 11, 3, 17, 10, 24, 604, DateTimeKind.Utc).AddTicks(4268),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("248a9c4c-236f-4604-bc70-f0e77ef97e96"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 11, 3, 17, 10, 24, 604, DateTimeKind.Utc).AddTicks(4275),
                            Description = "Commission rate for product sales",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Products",
                            UpdatedAt = new DateTime(2025, 11, 3, 17, 10, 24, 604, DateTimeKind.Utc).AddTicks(4275),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("734e77f4-e395-46a9-856d-dc813ab93c0b"),
                            Category = "Security",
                            CreatedAt = new DateTime(2025, 11, 3, 17, 10, 24, 604, DateTimeKind.Utc).AddTicks(4289),
                            Description = "OTP expiry time in minutes",
                            IsDeleted = false,
                            IsPublic = false,
                            Key = "OTP_ExpiryMinutes",
                            UpdatedAt = new DateTime(2025, 11, 3, 17, 10, 24, 604, DateTimeKind.Utc).AddTicks(4289),
                            Value = "5"
                        });
                });
