...
namespace tourimate.Migrations
{
    ...
    [Migration("20250929125241_InitialCreateClean")]
            ...
            modelBuilder.Entity("Entities.Models.ProductCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 29, 12, 52, 41, 455, DateTimeKind.Utc).AddTicks(3888),
                            Description = "Traditional Vietnamese food and drinks",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Food & Beverages",
                            SortOrder = 1,
                            UpdatedAt = new DateTime(2025, 9, 29, 12, 52, 41, 455, DateTimeKind.Utc).AddTicks(3889)
                        },
                        new
                        {
                            Id = new Guid("22222222-2222-2222-2222-222222222222"),
                            CreatedAt = new DateTime(2025, 9, 29, 12, 52, 41, 455, DateTimeKind.Utc).AddTicks(3894),
                            Description = "Handmade crafts and artisan products",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Handicrafts",
                            SortOrder = 2,
                            UpdatedAt = new DateTime(2025, 9, 29, 12, 52, 41, 455, DateTimeKind.Utc).AddTicks(3894)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2025, 9, 29, 12, 52, 41, 455, DateTimeKind.Utc).AddTicks(3898),
                            Description = "Traditional clothing and fabrics",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Textiles",
                            SortOrder = 3,
                            UpdatedAt = new DateTime(2025, 9, 29, 12, 52, 41, 455, DateTimeKind.Utc).AddTicks(3899)
                        });
                });
            ...
            modelBuilder.Entity("Entities.Models.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ce7950ce-4fac-447f-b15a-457fca712768"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 9, 29, 12, 52, 41, 455, DateTimeKind.Utc).AddTicks(4114),
                            Description = "Commission rate for tour bookings",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Tours",
                            UpdatedAt = new DateTime(2025, 9, 29, 12, 52, 41, 455, DateTimeKind.Utc).AddTicks(4115),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("0fe96844-3b5d-489d-885d-febd02025f97"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 9, 29, 12, 52, 41, 455, DateTimeKind.Utc).AddTicks(4118),
                            Description = "Commission rate for product sales",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Products",
                            UpdatedAt = new DateTime(2025, 9, 29, 12, 52, 41, 455, DateTimeKind.Utc).AddTicks(4118),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("5064cd96-d73c-4c0b-9779-7dfb3b928100"),
                            Category = "Security",
                            CreatedAt = new DateTime(2025, 9, 29, 12, 52, 41, 455, DateTimeKind.Utc).AddTicks(4142),
                            Description = "OTP expiry time in minutes",
                            IsDeleted = false,
                            IsPublic = false,
                            Key = "OTP_ExpiryMinutes",
                            UpdatedAt = new DateTime(2025, 9, 29, 12, 52, 41, 455, DateTimeKind.Utc).AddTicks(4142),
                            Value = "5"
                        });
                });
