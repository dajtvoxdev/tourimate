...
namespace tourimate.Migrations
{
    ...
    [Migration("20251028045048_IncreaseTransactionFieldSizes")]
    partial class IncreaseTransactionFieldSizes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Models.ProductCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 28, 4, 50, 47, 948, DateTimeKind.Utc).AddTicks(1174),
                            Description = "Traditional Vietnamese food and drinks",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Food & Beverages",
                            SortOrder = 1,
                            UpdatedAt = new DateTime(2025, 10, 28, 4, 50, 47, 948, DateTimeKind.Utc).AddTicks(1175)
                        },
                        new
                        {
                            Id = new Guid("22222222-2222-2222-2222-222222222222"),
                            CreatedAt = new DateTime(2025, 10, 28, 4, 50, 47, 948, DateTimeKind.Utc).AddTicks(1179),
                            Description = "Handmade crafts and artisan products",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Handicrafts",
                            SortOrder = 2,
                            UpdatedAt = new DateTime(2025, 10, 28, 4, 50, 47, 948, DateTimeKind.Utc).AddTicks(1179)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2025, 10, 28, 4, 50, 47, 948, DateTimeKind.Utc).AddTicks(1183),
                            Description = "Traditional clothing and fabrics",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Textiles",
                            SortOrder = 3,
                            UpdatedAt = new DateTime(2025, 10, 28, 4, 50, 47, 948, DateTimeKind.Utc).AddTicks(1183)
                        });
                });
            ...
            modelBuilder.Entity("Entities.Models.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("432fdaf8-c3ac-44cd-808f-df6b2bc7b97d"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 10, 28, 4, 50, 47, 948, DateTimeKind.Utc).AddTicks(1415),
                            Description = "Commission rate for tour bookings",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Tours",
                            UpdatedAt = new DateTime(2025, 10, 28, 4, 50, 47, 948, DateTimeKind.Utc).AddTicks(1415),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("28d79857-b746-4cc8-9140-e4b1abf45afa"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 10, 28, 4, 50, 47, 948, DateTimeKind.Utc).AddTicks(1433),
                            Description = "Commission rate for product sales",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Products",
                            UpdatedAt = new DateTime(2025, 10, 28, 4, 50, 47, 948, DateTimeKind.Utc).AddTicks(1433),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("b4c8782b-bef1-4ad2-89ce-066c8351de14"),
                            Category = "Security",
                            CreatedAt = new DateTime(2025, 10, 28, 4, 50, 47, 948, DateTimeKind.Utc).AddTicks(1436),
                            Description = "OTP expiry time in minutes",
                            IsDeleted = false,
                            IsPublic = false,
                            Key = "OTP_ExpiryMinutes",
                            UpdatedAt = new DateTime(2025, 10, 28, 4, 50, 47, 948, DateTimeKind.Utc).AddTicks(1436),
                            Value = "5"
                        });
                });
