...
namespace tourimate.Migrations
{
    ...
    [Migration("20251104023549_AddSelectedVariantToShoppingCart")]
    partial class AddSelectedVariantToShoppingCart
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Models.ProductCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 4, 2, 35, 48, 684, DateTimeKind.Utc).AddTicks(8193),
                            Description = "Traditional Vietnamese food and drinks",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Food & Beverages",
                            SortOrder = 1,
                            UpdatedAt = new DateTime(2025, 11, 4, 2, 35, 48, 684, DateTimeKind.Utc).AddTicks(8194)
                        },
                        new
                        {
                            Id = new Guid("22222222-2222-2222-2222-222222222222"),
                            CreatedAt = new DateTime(2025, 11, 4, 2, 35, 48, 684, DateTimeKind.Utc).AddTicks(8199),
                            Description = "Handmade crafts and artisan products",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Handicrafts",
                            SortOrder = 2,
                            UpdatedAt = new DateTime(2025, 11, 4, 2, 35, 48, 684, DateTimeKind.Utc).AddTicks(8199)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2025, 11, 4, 2, 35, 48, 684, DateTimeKind.Utc).AddTicks(8202),
                            Description = "Traditional clothing and fabrics",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Textiles",
                            SortOrder = 3,
                            UpdatedAt = new DateTime(2025, 11, 4, 2, 35, 48, 684, DateTimeKind.Utc).AddTicks(8203)
                        });
                });
            ...
            modelBuilder.Entity("Entities.Models.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c4136248-06e2-4b96-8dc0-bb09b9e4ad59"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 11, 4, 2, 35, 48, 684, DateTimeKind.Utc).AddTicks(8477),
                            Description = "Commission rate for tour bookings",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Tours",
                            UpdatedAt = new DateTime(2025, 11, 4, 2, 35, 48, 684, DateTimeKind.Utc).AddTicks(8478),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("ea8ee003-dc6a-4a4b-a496-bb2a20c71a8e"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 11, 4, 2, 35, 48, 684, DateTimeKind.Utc).AddTicks(8482),
                            Description = "Commission rate for product sales",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Products",
                            UpdatedAt = new DateTime(2025, 11, 4, 2, 35, 48, 684, DateTimeKind.Utc).AddTicks(8482),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("8b4333a4-45db-46d4-b709-98ac6f1885e4"),
                            Category = "Security",
                            CreatedAt = new DateTime(2025, 11, 4, 2, 35, 48, 684, DateTimeKind.Utc).AddTicks(8485),
                            Description = "OTP expiry time in minutes",
                            IsDeleted = false,
                            IsPublic = false,
                            Key = "OTP_ExpiryMinutes",
                            UpdatedAt = new DateTime(2025, 11, 4, 2, 35, 48, 684, DateTimeKind.Utc).AddTicks(8486),
                            Value = "5"
                        });
                });
