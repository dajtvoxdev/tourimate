...
namespace tourimate.Migrations
{
    ...
    [Migration("20251019130352_AddSePayTransaction")]
            ...
            modelBuilder.Entity("Entities.Models.ProductCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 19, 13, 3, 51, 500, DateTimeKind.Utc).AddTicks(2791),
                            Description = "Traditional Vietnamese food and drinks",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Food & Beverages",
                            SortOrder = 1,
                            UpdatedAt = new DateTime(2025, 10, 19, 13, 3, 51, 500, DateTimeKind.Utc).AddTicks(2791)
                        },
                        new
                        {
                            Id = new Guid("22222222-2222-2222-2222-222222222222"),
                            CreatedAt = new DateTime(2025, 10, 19, 13, 3, 51, 500, DateTimeKind.Utc).AddTicks(2796),
                            Description = "Handmade crafts and artisan products",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Handicrafts",
                            SortOrder = 2,
                            UpdatedAt = new DateTime(2025, 10, 19, 13, 3, 51, 500, DateTimeKind.Utc).AddTicks(2797)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2025, 10, 19, 13, 3, 51, 500, DateTimeKind.Utc).AddTicks(2800),
                            Description = "Traditional clothing and fabrics",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Textiles",
                            SortOrder = 3,
                            UpdatedAt = new DateTime(2025, 10, 19, 13, 3, 51, 500, DateTimeKind.Utc).AddTicks(2801)
                        });
                });
            ...
            modelBuilder.Entity("Entities.Models.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7f5cb398-f4c0-4d8a-99eb-74985aa0a4bd"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 10, 19, 13, 3, 51, 500, DateTimeKind.Utc).AddTicks(3017),
                            Description = "Commission rate for tour bookings",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Tours",
                            UpdatedAt = new DateTime(2025, 10, 19, 13, 3, 51, 500, DateTimeKind.Utc).AddTicks(3018),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("214c7489-24f3-4b72-97c7-5effd7286d15"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 10, 19, 13, 3, 51, 500, DateTimeKind.Utc).AddTicks(3021),
                            Description = "Commission rate for product sales",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Products",
                            UpdatedAt = new DateTime(2025, 10, 19, 13, 3, 51, 500, DateTimeKind.Utc).AddTicks(3021),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("925a5c02-17b9-4535-9faf-01777f74a7e7"),
                            Category = "Security",
                            CreatedAt = new DateTime(2025, 10, 19, 13, 3, 51, 500, DateTimeKind.Utc).AddTicks(3024),
                            Description = "OTP expiry time in minutes",
                            IsDeleted = false,
                            IsPublic = false,
                            Key = "OTP_ExpiryMinutes",
                            UpdatedAt = new DateTime(2025, 10, 19, 13, 3, 51, 500, DateTimeKind.Utc).AddTicks(3025),
                            Value = "5"
                        });
                });
