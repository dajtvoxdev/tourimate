...
namespace tourimate.Migrations
{
    ...
    [Migration("20251103182733_RemoveProductsUserIdColumn")]
    partial class RemoveProductsUserIdColumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Models.ProductCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 3, 18, 27, 33, 70, DateTimeKind.Utc).AddTicks(9905),
                            Description = "Traditional Vietnamese food and drinks",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Food & Beverages",
                            SortOrder = 1,
                            UpdatedAt = new DateTime(2025, 11, 3, 18, 27, 33, 70, DateTimeKind.Utc).AddTicks(9906)
                        },
                        new
                        {
                            Id = new Guid("22222222-2222-2222-2222-222222222222"),
                            CreatedAt = new DateTime(2025, 11, 3, 18, 27, 33, 70, DateTimeKind.Utc).AddTicks(9910),
                            Description = "Handmade crafts and artisan products",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Handicrafts",
                            SortOrder = 2,
                            UpdatedAt = new DateTime(2025, 11, 3, 18, 27, 33, 70, DateTimeKind.Utc).AddTicks(9910)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2025, 11, 3, 18, 27, 33, 70, DateTimeKind.Utc).AddTicks(9914),
                            Description = "Traditional clothing and fabrics",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Textiles",
                            SortOrder = 3,
                            UpdatedAt = new DateTime(2025, 11, 3, 18, 27, 33, 70, DateTimeKind.Utc).AddTicks(9914)
                        });
                });
            ...
            modelBuilder.Entity("Entities.Models.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("69f5fef8-78c3-4988-8c5d-76fd882638f5"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 11, 3, 18, 27, 33, 71, DateTimeKind.Utc).AddTicks(207),
                            Description = "Commission rate for tour bookings",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Tours",
                            UpdatedAt = new DateTime(2025, 11, 3, 18, 27, 33, 71, DateTimeKind.Utc).AddTicks(208),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("03dfefa0-023f-477b-84d3-35375806a58d"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 11, 3, 18, 27, 33, 71, DateTimeKind.Utc).AddTicks(230),
                            Description = "Commission rate for product sales",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Products",
                            UpdatedAt = new DateTime(2025, 11, 3, 18, 27, 33, 71, DateTimeKind.Utc).AddTicks(231),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("0dbbc1a0-d848-4a1e-a76d-8a0e5e7d2e02"),
                            Category = "Security",
                            CreatedAt = new DateTime(2025, 11, 3, 18, 27, 33, 71, DateTimeKind.Utc).AddTicks(234),
                            Description = "OTP expiry time in minutes",
                            IsDeleted = false,
                            IsPublic = false,
                            Key = "OTP_ExpiryMinutes",
                            UpdatedAt = new DateTime(2025, 11, 3, 18, 27, 33, 71, DateTimeKind.Utc).AddTicks(234),
                            Value = "5"
                        });
                });
