...
namespace tourimate.Migrations
{
    ...
    [Migration("20251027034635_SetDefaultTourRatingTo4")]
    partial class SetDefaultTourRatingTo4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Models.ProductCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 27, 3, 46, 31, 938, DateTimeKind.Utc).AddTicks(2856),
                            Description = "Traditional Vietnamese food and drinks",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Food & Beverages",
                            SortOrder = 1,
                            UpdatedAt = new DateTime(2025, 10, 27, 3, 46, 31, 938, DateTimeKind.Utc).AddTicks(2857)
                        },
                        new
                        {
                            Id = new Guid("22222222-2222-2222-2222-222222222222"),
                            CreatedAt = new DateTime(2025, 10, 27, 3, 46, 31, 938, DateTimeKind.Utc).AddTicks(2862),
                            Description = "Handmade crafts and artisan products",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Handicrafts",
                            SortOrder = 2,
                            UpdatedAt = new DateTime(2025, 10, 27, 3, 46, 31, 938, DateTimeKind.Utc).AddTicks(2863)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2025, 10, 27, 3, 46, 31, 938, DateTimeKind.Utc).AddTicks(2866),
                            Description = "Traditional clothing and fabrics",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Textiles",
                            SortOrder = 3,
                            UpdatedAt = new DateTime(2025, 10, 27, 3, 46, 31, 938, DateTimeKind.Utc).AddTicks(2866)
                        });
                });
            ...
            modelBuilder.Entity("Entities.Models.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ffb2bddc-4c2b-410e-82a8-0ee356c239c7"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 10, 27, 3, 46, 31, 938, DateTimeKind.Utc).AddTicks(3096),
                            Description = "Commission rate for tour bookings",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Tours",
                            UpdatedAt = new DateTime(2025, 10, 27, 3, 46, 31, 938, DateTimeKind.Utc).AddTicks(3097),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("eb25446a-ac23-4a48-80ba-af2379acf84c"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 10, 27, 3, 46, 31, 938, DateTimeKind.Utc).AddTicks(3100),
                            Description = "Commission rate for product sales",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Products",
                            UpdatedAt = new DateTime(2025, 10, 27, 3, 46, 31, 938, DateTimeKind.Utc).AddTicks(3101),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("b45ad8ca-e88e-47a1-9b6e-48b8d5cf7466"),
                            Category = "Security",
                            CreatedAt = new DateTime(2025, 10, 27, 3, 46, 31, 938, DateTimeKind.Utc).AddTicks(3108),
                            Description = "OTP expiry time in minutes",
                            IsDeleted = false,
                            IsPublic = false,
                            Key = "OTP_ExpiryMinutes",
                            UpdatedAt = new DateTime(2025, 10, 27, 3, 46, 31, 938, DateTimeKind.Utc).AddTicks(3108),
                            Value = "5"
                        });
                });
