...
namespace tourimate.Migrations
{
    ...
    [Migration("20251103171155_MakeProductVariantsJsonUnlimited")]
    partial class MakeProductVariantsJsonUnlimited
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Models.ProductCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 3, 17, 11, 54, 815, DateTimeKind.Utc).AddTicks(6697),
                            Description = "Traditional Vietnamese food and drinks",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Food & Beverages",
                            SortOrder = 1,
                            UpdatedAt = new DateTime(2025, 11, 3, 17, 11, 54, 815, DateTimeKind.Utc).AddTicks(6698)
                        },
                        new
                        {
                            Id = new Guid("22222222-2222-2222-2222-222222222222"),
                            CreatedAt = new DateTime(2025, 11, 3, 17, 11, 54, 815, DateTimeKind.Utc).AddTicks(6703),
                            Description = "Handmade crafts and artisan products",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Handicrafts",
                            SortOrder = 2,
                            UpdatedAt = new DateTime(2025, 11, 3, 17, 11, 54, 815, DateTimeKind.Utc).AddTicks(6703)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2025, 11, 3, 17, 11, 54, 815, DateTimeKind.Utc).AddTicks(6706),
                            Description = "Traditional clothing and fabrics",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Textiles",
                            SortOrder = 3,
                            UpdatedAt = new DateTime(2025, 11, 3, 17, 11, 54, 815, DateTimeKind.Utc).AddTicks(6706)
                        });
                });
            ...
            modelBuilder.Entity("Entities.Models.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fc4418e2-b15a-4d9d-abb2-9c676925eefb"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 11, 3, 17, 11, 54, 815, DateTimeKind.Utc).AddTicks(6918),
                            Description = "Commission rate for tour bookings",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Tours",
                            UpdatedAt = new DateTime(2025, 11, 3, 17, 11, 54, 815, DateTimeKind.Utc).AddTicks(6918),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("71f1b9e7-1b5d-4e0a-a437-a99dbb3db99a"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 11, 3, 17, 11, 54, 815, DateTimeKind.Utc).AddTicks(6922),
                            Description = "Commission rate for product sales",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Products",
                            UpdatedAt = new DateTime(2025, 11, 3, 17, 11, 54, 815, DateTimeKind.Utc).AddTicks(6922),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("51664a6e-b7e0-4a68-8142-36c6e64833c2"),
                            Category = "Security",
                            CreatedAt = new DateTime(2025, 11, 3, 17, 11, 54, 815, DateTimeKind.Utc).AddTicks(6929),
                            Description = "OTP expiry time in minutes",
                            IsDeleted = false,
                            IsPublic = false,
                            Key = "OTP_ExpiryMinutes",
                            UpdatedAt = new DateTime(2025, 11, 3, 17, 11, 54, 815, DateTimeKind.Utc).AddTicks(6930),
                            Value = "5"
                        });
                });
