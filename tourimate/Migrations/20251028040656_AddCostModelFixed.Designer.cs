...
namespace tourimate.Migrations
{
    ...
    [Migration("20251028040656_AddCostModelFixed")]
    partial class AddCostModelFixed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Models.ProductCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 28, 4, 6, 55, 178, DateTimeKind.Utc).AddTicks(5347),
                            Description = "Traditional Vietnamese food and drinks",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Food & Beverages",
                            SortOrder = 1,
                            UpdatedAt = new DateTime(2025, 10, 28, 4, 6, 55, 178, DateTimeKind.Utc).AddTicks(5348)
                        },
                        new
                        {
                            Id = new Guid("22222222-2222-2222-2222-222222222222"),
                            CreatedAt = new DateTime(2025, 10, 28, 4, 6, 55, 178, DateTimeKind.Utc).AddTicks(5353),
                            Description = "Handmade crafts and artisan products",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Handicrafts",
                            SortOrder = 2,
                            UpdatedAt = new DateTime(2025, 10, 28, 4, 6, 55, 178, DateTimeKind.Utc).AddTicks(5353)
                        },
                        new
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2025, 10, 28, 4, 6, 55, 178, DateTimeKind.Utc).AddTicks(5356),
                            Description = "Traditional clothing and fabrics",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Textiles",
                            SortOrder = 3,
                            UpdatedAt = new DateTime(2025, 10, 28, 4, 6, 55, 178, DateTimeKind.Utc).AddTicks(5357)
                        });
                });
            ...
            modelBuilder.Entity("Entities.Models.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1044fbf7-2b72-41c0-9e40-ad2ced8d1921"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 10, 28, 4, 6, 55, 178, DateTimeKind.Utc).AddTicks(5637),
                            Description = "Commission rate for tour bookings",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Tours",
                            UpdatedAt = new DateTime(2025, 10, 28, 4, 6, 55, 178, DateTimeKind.Utc).AddTicks(5637),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("1ce2aa24-1fca-4558-9902-e33771acde13"),
                            Category = "Finance",
                            CreatedAt = new DateTime(2025, 10, 28, 4, 6, 55, 178, DateTimeKind.Utc).AddTicks(5653),
                            Description = "Commission rate for product sales",
                            IsDeleted = false,
                            IsPublic = true,
                            Key = "CommissionRate_Products",
                            UpdatedAt = new DateTime(2025, 10, 28, 4, 6, 55, 178, DateTimeKind.Utc).AddTicks(5654),
                            Value = "0.15"
                        },
                        new
                        {
                            Id = new Guid("87547ae4-fbc0-4eca-8994-15cfc33c57aa"),
                            Category = "Security",
                            CreatedAt = new DateTime(2025, 10, 28, 4, 6, 55, 178, DateTimeKind.Utc).AddTicks(5657),
                            Description = "OTP expiry time in minutes",
                            IsDeleted = false,
                            IsPublic = false,
                            Key = "OTP_ExpiryMinutes",
                            UpdatedAt = new DateTime(2025, 10, 28, 4, 6, 55, 178, DateTimeKind.Utc).AddTicks(5657),
                            Value = "5"
                        });
                });
