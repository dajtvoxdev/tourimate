...
"@
        ...
        $scpBackendCmdWithPass = @"
sshpass -e scp -P $($Config.VpsPort) -r `"$($Config.BackendBuildPath)\*`" $($Config.VpsUser)@$($Config.VpsHost):'C:\inetpub\wwwroot\tourimate-production\'
"@
...
"@
        ...
        $scpFrontendCmdWithPass = @"
sshpass -e scp -P $($Config.VpsPort) -r `"$($Config.FrontendBuildPath)\*`" $($Config.VpsUser)@$($Config.VpsHost):'C:\inetpub\wwwroot\tourimate-frontend-production\'
"@
